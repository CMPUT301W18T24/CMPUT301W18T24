...
public class SignupTest {
    ...
    public void SignupTest() {
        ...
        onView(withId(R.id.editTextUserName)).perform(replaceText("123"), closeSoftKeyboard());
        ...
        onView(withId(R.id.editTextPass)).perform(replaceText("1234561111"), closeSoftKeyboard());
        //check if text has been successfully typed in editTextPass
        allOf(withId(R.id.editTextPass), withText("1234561111"), isDisplayed());
        ...
        onView(withId(R.id.editTextEmail)).perform(replaceText("1234@gmail.com"), closeSoftKeyboard());
